<!DOCTYPE html>
<!-- saved from url=(0024)http://alchemy.nitt.edu/ -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <title>Alchemy'17 - Annual Chemical Engineering Department symposium of NIT Trichy </title>
  ...
  unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2212, U+2215;
    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <span class="footer" style="color: black">Made with <span style="color:red;">&hearts;</span> by <a href="https://www.facebook.com/GaneGuru" target="_blank" style="color: #ECC82C !important;"><b>Ganesh Raghavendran</b></a></span>
        </div>
